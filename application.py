...
<head>
  ...
  <title>Welcome to my little world of wuttoobe</title>
  <style>
  body {
    color: #ffffff;
...
<body id="sample">
  <div class="textColumn">
    ...
    <p>Your first AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud that can't be worked out</p>
    <p>This environment is launched with Elastic Beanstalk Python Platform already screwed up by wuttoobe</p>
  </div>
